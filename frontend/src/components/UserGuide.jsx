...
export default function UserGuide() {
  ...
  const content = {
    pl: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            {
              subtitle: 'Q: Czy mogę edytować istniejące zamówienie?',
              text: 'A: Obecnie system nie obsługuje bezpośredniej edycji. Możesz utworzyć nowe zamówienie z poprawnymi danymi.'
            },
            {
              subtitle: 'Q: Jak usunąć błędnie wprowadzony wpis?',
              text: 'A: Skontaktuj się z administratorem systemu, który może wykonać korekty w bazie danych.'
            },
            {
              subtitle: 'Q: Dlaczego nie widzę przycisku "Dodaj"?',
              text: 'A: Upewnij się, że wprowadziłeś klucz API w odpowiedniej sekcji. Bez klucza dostępny jest tylko tryb odczytu.'
            },
            {
              subtitle: 'Q: Jak mogę eksportować dane?',
              text: 'A: Użyj przeglądarki do skopiowania danych lub skontaktuj się z administratorem w sprawie eksportu do pliku.'
            }
          ]
        }
      ]
    ...
    en: {
      title: 'User Guide',
      intro: 'Welcome to Arkuszownia SMB - a comprehensive production management system. This guide will help you fully utilize the application\'s capabilities.',
      sections: [
        {
