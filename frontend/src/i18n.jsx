...
const translations = {
  en: {
    ...
    password_requirements: 'At least 8 characters with letter, number and special character',
    password_hint: 'Must contain uppercase, lowercase, number and special character',
    changing: 'Changing...',
  ...
  pl: {
    ...
    password_requirements: 'Minimum 8 znaków: litera, liczba i znak specjalny',
    password_hint: 'Musi zawierać duże litery, małe litery, cyfrę i znak specjalny',
    changing: 'Zmiana...',
    admin_tools: 'Narzędzia administracyjne',
    admin_panel: 'Panel administracyjny',
    view_audit_logs: 'Wyświetl dziennik audytu',
  }
}
